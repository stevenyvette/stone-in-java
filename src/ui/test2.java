...
public class test2 {
	...
	public void test(){
		...
		Container container;
		try {
		    File file = new File(getClass().getResource("/resources/polblogs.gml").toURI());//polblogs.gml     graph.gexf
		...
		AttributeColumn centralityColumn = attributeModel.getNodeTable().getColumn(GraphDistance.BETWEENNESS); // GraphDistance.BETWEENNESS = betweenesscentrality 介数中心性！
		...
		model.getProperties().putValue(PreviewProperty.EDGE_COLOR, new EdgeColor(Color.YELLOW));
